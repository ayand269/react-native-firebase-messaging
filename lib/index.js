...
class FirebaseMessagingModule extends FirebaseModule {
  constructor(...args) {
    ...
    AppRegistry.registerHeadlessTask('ReactNativeFirebaseMessagingHeadlessTask', () => {
      // console.log("backgroundMessageHandler",backgroundMessageHandler)
  ...
  stopAlarmRing() {
    return this.native.stopAlarmRing();
  }

  startParmisonRing() {
    return this.native.startParmisonRing();
  }

  checkParmisonRing() {
    return this.native.checkParmisonRing();
  }
